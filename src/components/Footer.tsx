        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-4">
              <span className="text-[10px] uppercase font-bold text-text-muted hover:text-primary cursor-pointer transition-colors">Privacy</span>
              <span className="text-[10px] uppercase font-bold text-text-muted hover:text-primary cursor-pointer transition-colors">Terms</span>
            </div>
          </div>
          
          <div className="flex flex-wrap gap-4">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="social-btn social-btn-github">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="social-btn social-btn-linkedin">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="social-btn social-btn-discord">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
